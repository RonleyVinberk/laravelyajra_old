...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <a class="btn btn-primary" role="button" href="{{route('items.create')}}"><i class="fa fa-plus"></i> Create</a>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption">
                                ...
                                <span class="caption-subject uppercase">Items</span>
                            </div>
                            <!-- end caption -->
                        </div>
                        <!-- end portlet-title -->
                        ...
                        <div class="portlet-body flip-scroll">
                            ...
                            <script id="item_detail" type="text/x-handlebars-template">
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td style="width: 15%">Purchase Price</td>
                                        <td>@{{harga_beli}}</td>
                                    </tr>
                                    <tr>
                                        <td>Information</td>
