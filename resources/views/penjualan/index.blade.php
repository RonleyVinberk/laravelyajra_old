...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <a class="btn btn-primary" role="button" href="{{route('sales.create')}}"><i class="fa fa-plus"></i> Create</a>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption">
                                ...
                                <span class="caption-subject uppercase">Sales</span>
                            </div>
                            <!-- end caption -->
                        </div>
                        <!-- end portlet-title -->
                        ...
                        <div class="portlet-body flip-scroll">
                            <table class="table table-striped table-bordered table-hover" id="penjualan_table">
                            ...
                            <script id="penjualan_detail" type="text/x-handlebars-template">
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        <td style="width: 15%">Number of Items</td>
                                        <td>@{{jumlah_barang}}</td>
                                    </tr>
                                    <tr>
                                        <td>Item Price</td>
