...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <a class="btn btn-primary" role="button" href="{{route('customers.create')}}"><i class="fa fa-plus"></i> Create</a>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption">
                                ...
                                <span class="caption-subject uppercase">Customers</span>
                            </div>
                            <!-- end caption -->
                        </div>
                        <!-- end portlet-title -->
                        ...
                        <div class="portlet-body flip-scroll">
                            ...
                            <script id="customer_detail" type="text/x-handlebars-template">
