...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <a class="btn btn-primary" role="button" href="{{route('coupons.create')}}"><i class="fa fa-plus"></i> Create</a>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption">
                                ...
                                <span class="caption-subject uppercase">Coupons</span>
                            </div>
                            <!-- end caption -->
                        </div>
                        <!-- end portlet-title -->
                        ...
                        <div class="portlet-body flip-scroll">
                            <table class="table table-striped table-bordered table-hover" id="kupon_table">
                            ...
                            <script id="kupon_detail" type="text/x-handlebars-template">
